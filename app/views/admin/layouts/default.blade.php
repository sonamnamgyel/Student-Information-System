                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li{{ (Request::is('admin/departments*') ? ' class="active"' : '') }}>
                            <a href="{{{ URL::to('admin/departments') }}}"><span class="fa fa-institution"></span> Departments</a>
                        </li>

                        <li{{ (Request::is('admin/programmes*') ? ' class="active"' : '') }}>
                            <a href="{{{ URL::to('admin/programmes') }}}"><span class="fa fa-star-o"></span> Programmes </a>
                        </li>
                        ...
                        <li class="treeview {{ Request::is('admin/courses*')? 'active' : '' }}">
                            ...
                            <?php
                                $programmes = Programme::select('id', 'programme_code')->get();
                            ?>
                            <ul class="treeview-menu">
                            @foreach($programmes as $prog)
                                <li><a href="{{ URL::to('admin/courses/'.$prog->id) }}"> <i class="fa fa-angle-double-right"></i>{{ $prog->programme_code }}</a></li>
                            @endforeach
                            </ul>
                        </li>

                        <li class="treeview {{ (Request::is('admin/staffs*')? 'active' : '') }}">
                            <a href="#"><i class="fa fa-male"></i><span>Staffs</span>
                                <i class="fa fa-angle-left pull-right"></i></a>
                            <?php
                            ...
                            @foreach($departments as $dep)
                                <li><a href="{{ URL::to('admin/staffs/'.$dep->id) }}"> <i class="fa fa-angle-double-right"></i>{{ $dep->department_name }}</a></li>
                            @endforeach
                            </ul>
                        </li>
                        
                        <li{{ (Request::is('admin/students*') ? ' class="active"' : '') }}>
                            <a href="{{{ URL::to('admin/students') }}}"><span class="fa fa-graduation-cap"></span> Students</a>
                        </li>

                        <li{{ (Request::is('admin/accounts*') ? ' class="active"' : '') }}>
                            <a href="{{{ URL::to('admin/accounts') }}}"><span class="fa fa-credit-card"></span> Accounts</a>
                        </li>
                        @endif
